        ...
        <div class="card" style="font-size: 20px;">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="<?= BASE_URL ?>/post/insertPost" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Chi tiết bài viết</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="10" style="resize: none;" name="content_post"></textarea>
                  </div>
                </div>
                <div class="row mb-3">
