              ...
              <table class="table">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= BASE_URL ?>/product/editCategory/<?=$value['id_category']?>"><i title="Sửa" class="bi bi-wrench"></i></a> ||
                                <a href="<?= BASE_URL ?>/product/deleteCategory/<?=$value['id_category']?>"><i title="Xóa" class="bi bi-trash3"></i></a>
                            </td>
                        </tr>
                <?php
                    $stt++;
